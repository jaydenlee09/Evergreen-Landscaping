    ...
    <div className="relative w-full h-[100vh] overflow-hidden">
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center px-4">
        <div className="max-w-5xl transition-all duration-700 ease-in-out transform">
          <h1 
            className={`font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight mb-8 transition-all duration-700 tracking-wide ${
          ...
          <Button 
            asChild
            className="bg-green-600 hover:bg-green-500 text-white text-lg px-8 py-7 rounded-md shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            size="lg"
          >
